...
- Screen-reader semantics:
  - карточка объявляет «Лечо, осталось 700 мл, Дача, Погреб, Полка 1»;
  - action label включает результат: «Взять 100 мл лечо»;
...
- встроенная категория автоматически задаёт единицу: овощи/фрукты — `шт.`, варенье/соусы/напитки — `мл`, грибы/заморозка/сушка — `г`; «Другое» раскрывает свою категорию и единицу;
- превью в каталоге показывает последний снимок, а карточка партии листает все фото горизонтальным жестом и имеет видимый счётчик;
...
- [x] Content: утверждён MVP-словарь единиц — `шт.`, `мл`, `г` и пользовательская единица для своей категории.
